...
2.  **Manual (`workflow_dispatch`)**: You can trigger the `generate-songbook` workflow manually from the "Actions" tab in the GitHub repository. You will need to specify which edition to generate.
