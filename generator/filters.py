    ...
    def parse_simple_filter(filter_str: str) -> PropertyFilter:
        ...
        if len(parts) == 2:
            ...
            try:
                ...
                raise ValueError(f"Unknown operator: {op_str}. Valid operators: {[op.value for op in FilterOperator]}")
            ...
            raise ValueError(f"Invalid filter format: {filter_str}. Use 'key:value' or 'key:operator:value'")
